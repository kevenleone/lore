    ...
    return (
        <div style={{ flex: 1, overflow: 'auto', padding: '28px 34px' }}>
            ...
            <div style={{ alignItems: 'center', display: 'flex', gap: 12, position: 'relative' }}>
                ...
                <span style={{ alignItems: 'center', display: 'flex', gap: 8, marginLeft: 'auto' }}>
                    {linkUrl && (
                        <span
                ...
                {confirmDelete && (
                    ...
                    >
                        <div
                            style={{ color: 'var(--text, #1a1a1f)', fontSize: 14, fontWeight: 600 }}
                        >
                            Delete this item?
                        </div>
                        <div
                            style={{ color: 'var(--text3, #9a9aa5)', fontSize: 12.5, marginTop: 4 }}
                        >
            ...
            {bodyField && editingBody ? (
                ...
                <p
                    onClick={startBody}
                    style={{
                        color: sel.description ? 'var(--text2, #3b3b44)' : 'var(--faint, #b3b3bd)',
                        cursor: 'text',
                        fontSize: 14.5,
                        lineHeight: 1.6,
                        margin: '18px 0 4px',
