...
export function Check({ size = 12, style, sw = 2.4 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function ChevronDown({ size = 13, style, sw = 2 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function ChevronRight({ size = 16, style, sw = 2 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function Close({ size = 18, style, sw = 1.9 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function FileGlyph({ size = 20, style, sw = 1.7 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function Search({ size = 15, style, sw = 1.9 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function Send({ size = 16, style, sw = 1.9 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function Settings({ size = 16, style, sw = 1.8 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function SidebarToggle({ size = 17, style, sw = 1.8 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
            <rect height="16" rx="2.5" width="18" x="3" y="4" />
...
export function StarOutline({ size = 18, style, sw = 1.7 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
export function Trash({ size = 16, style, sw = 1.8 }: GlyphProps) {
    return (
        <Stroke size={size} style={style} sw={sw}>
...
function Stroke({ children, size = 16, style, sw = 1.8 }: { children: ReactNode } & GlyphProps) {
    return (
        <svg
            fill="none"
            height={size}
