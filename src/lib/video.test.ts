...
describe('linkVideo', () => {
    it.each([
        ...
        [
            'https://player.vimeo.com/video/180094337?autoplay=1',
            { id: '180094337', provider: 'vimeo' },
        ],
    ])('reads %s', (url, video) => {
    ...
    it('ignores other links', () => {
        expect(linkVideo('https://example.com/video/180094337')).toBeNull();
    });
});

describe('videoEmbedUrl', () => {
    it('picks the player for the provider', () => {
        expect(videoEmbedUrl({ id: '180094337', provider: 'vimeo' })).toBe(
            'https://player.vimeo.com/video/180094337?autoplay=1&dnt=1',
        );
...
describe('videoThumbnail', () => {
    it('derives only YouTube thumbnails', () => {
        ...
        expect(videoThumbnail({ id: '180094337', provider: 'vimeo' })).toBeUndefined();
    });
});
